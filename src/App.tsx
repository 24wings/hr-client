...
const API_URL =
  "https://klvjaxqjuulmvlwelpro.hasura.eu-central-1.nhost.run/v1/graphql";
const WS_URL = "ws://flowing-mammal-24.hasura.app/v1/graphql";

const client = new GraphQLClient(API_URL, {
  headers: {
    "x-hasura-admin-secret": "2e1ci4l8k$m9RTohp9ckNve*H-k*:hFC",
  },
});
          ...
          <DevtoolsProvider>
            <Refine
              ...
              options={{
                ...
                liveMode: "auto",
                projectId: "OV3wPY-vaQN7y-7vCBdq",
              }}
            >
              <Routes>
                <Route
